...
for j in range(3):
    ...
    if j ==0:
        ...
        gp_model_file_path = f'gp_model_x_norm{factor}_eight.pkl'
    if j ==1:
        gp_model_y = opt_posterior
        #gp_model_file_path = home_path + 'gpmodels/gp_model_y_norm3.pkl'
        gp_model_file_path = f'gp_model_y_norm{factor}_eight.pkl'
    if j == 2:
        gp_model_z = opt_posterior
        gp_model_file_path = f'gp_model_z_norm{factor}_eight.pkl'
