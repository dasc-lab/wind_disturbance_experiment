...
if save :
    ...
    np.save('compare_trajectory/optimized_trajectory_cir_traj_r0.4_w1.0_c0.60_h0.5_kxv14_81_7_25.npy',stacked_array)
...
if save : 
    ...
    np.save('compare_trajectory/ideal_trajectory_cir_traj_r0.4_w1.0_c0.60_h0.5_kxv14_81_7_25.npy',stacked_array)
# Scatter plot
ax.set_zlim(0,1)
