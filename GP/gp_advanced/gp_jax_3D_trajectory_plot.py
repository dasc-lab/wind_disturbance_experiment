...
for j in range(3):
    ...
    gp_model_file_path = ''
    if j ==0:
        gp_model_file_path = 'gp_model_x_without_norm.pkl'
    if j ==1:
        gp_model_file_path = 'gp_model_y_without_norm.pkl'
    if j == 2:
        gp_model_file_path = 'gp_model_z_without_norm.pkl'
...
plt.savefig("GP without normalizing disturbance")
plt.show()
