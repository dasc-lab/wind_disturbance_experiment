...
import sys
import os
plotter_path = os.path.join('/Users/albusfang/Coding Projects/gp_ws/Gaussian Process/GP/gp_advanced/circle_fullset/')
...
dataset_path = home_path + 'circle_fullset/'
plot_path = dataset_path + 'train_plots/'
npy_path = dataset_path + 'npy_data_folder/'
disturbance_file_path = dataset_path + 'disturbance_full_circle.npy'
input_file_path = dataset_path + 'input_full_circle.npy'
...
for j in range(3):
    ...
    if j ==0:
        ...
        gp_model_file_path = gp_model_file_path + f'gp_model_x_norm{factor}_circle.pkl'
    if j ==1:
        gp_model_y = opt_posterior
        #gp_model_file_path = home_path + 'gpmodels/gp_model_y_norm3.pkl'
        gp_model_file_path = gp_model_file_path + f'gp_model_y_norm{factor}_circle.pkl'
    if j == 2:
        gp_model_z = opt_posterior
        gp_model_file_path = gp_model_file_path + f'gp_model_z_norm{factor}_circle.pkl'
