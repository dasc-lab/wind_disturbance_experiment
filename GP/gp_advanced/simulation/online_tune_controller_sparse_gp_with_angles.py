...
circ = plt.Circle((obs_center[0,0],obs_center[1,0]),0.5,linewidth = 1, edgecolor='k',facecolor='k')
ax.add_patch(circ)
# plt.show()
...
ax2.plot(rewards2_optimized, 'k--', label='states2 unoptimized')
