...
import os, sys
plotter_path = os.path.join('/Users/albusfang/Coding Projects/gp_ws/Gaussian Process/GP/gp_advanced/figure8_fullset/')
home_path = '/Users/albusfang/Coding Projects/gp_ws/Gaussian Process/GP/gp_advanced/figure8_fullset/'
sys.path.append(plotter_path)
from plot_trajectory_ref_figure8 import bag_path, cutoff, threshold
...
input_file_path = home_path+ 'input_full_figure8.npy'
disturbance_file_path = home_path+'disturbance_full_figure8.npy'
