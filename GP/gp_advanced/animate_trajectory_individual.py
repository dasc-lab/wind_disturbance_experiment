...
trajectory = ax.scatter( x[0], y[0], z[0], c = 'brown', s=20 )
ideal_trajectory = ax.scatter(x_ideal[0], y_ideal[0], z_ideal[0], c='deepskyblue', s= 20)
optimized_trajectory = ax.scatter(x_op[0], y_op[0], z_op[0], c='springgreen', s= 20)
T = x.shape[0]
