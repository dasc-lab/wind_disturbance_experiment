...
import pickle
home_path = '/Users/albusfang/Coding Projects/gp_ws/Gaussian Process/GP/gp_advanced_simple/'
...
npy_path = dataset_path + 'npy_data_folder/'
disturbance_file_path = dataset_path + 'disturbance.npy'
input_file_path = dataset_path + 'input.npy'
